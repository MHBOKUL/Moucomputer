...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="subtitle">
            Update Mouza information
        </div>

        <form
            action="{{ route('admin.mouzas.update', $mouza) }}"
            method="POST"
        >
            ...
            <div class="form-group">
                ...
                >
                    ...
                    @foreach($upazilas as $upazila)
                        ...
                        <option
                            value="{{ $upazila->id }}"
                            {{ old('upazila_id', $mouza->upazila_id) == $upazila->id ? 'selected' : '' }}
                        >
                            {{ $upazila->name }}
            ...
            <div class="form-group">
                ...
                >
                    ...
                    @foreach($surveyTypes as $surveyType)
                        ...
                        <option
                            value="{{ $surveyType->id }}"
                            {{ old('survey_type_id', $mouza->survey_type_id) == $surveyType->id ? 'selected' : '' }}
                        >
                            {{ $surveyType->name }}

                            @if($surveyType->name_bn)
                                — {{ $surveyType->name_bn }}
                            @endif
                        </option>
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    name="name_bn"
                    id="name_bn"
                    value="{{ old('name_bn', $mouza->name_bn) }}"
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    name="jl_number"
                    id="jl_number"
                    value="{{ old('jl_number', $mouza->jl_number) }}"
            ...
            <div class="form-group">
                ...
                <label class="checkbox">
                    ...
                    <input
                        ...
                        name="is_active"
                        value="1"
                        {{ old('is_active', $mouza->is_active) ? 'checked' : '' }}
                    >

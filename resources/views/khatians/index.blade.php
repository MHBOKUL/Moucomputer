    ...
    <section class="land-hero">
        ...
        <div class="land-container land-hero-content">
            ...
            <p class="land-hero-description">
                ...
                digital khatians and view the details of your required record.
        ...
        <div class="finder-card">
            ...
            <div class="finder-header">
                ...
                <p class="finder-header-description">
                    Select survey type and location to find available khatians.
                </p>
            ...
            <div class="finder-body">
                ...
                <div class="finder-grid">
                    ...
                    <div class="land-field">
                        ...
                        <input
                            ...
                            id="khatian_number"
                            name="khatian_number"
                            placeholder="Enter Khatian No. & press Enter"
                            autocomplete="off"
                            inputmode="numeric"
                        >
                    ...
                    <div class="maps-header">
                        ...
                        <div>
                            ...
                            <p class="maps-description">
                                Select a Khatian to view details and place your order.
                            </p>
                ...
                >
                    ...
                    <div class="empty-icon">
                        ...
                        >
                            ...
                            <path
                                ...
                                stroke-width="1.8"
                                d="M6 2h9l5 5v15H6V2zm9 0v6h5M9 13h6M9 17h4"
                            />
                    ...
                    <h3 class="empty-title">
                        No Khatians Available
                    </h3>


                    <p
                        id="no-khatians-description"
                        class="empty-description"
                    >
                        No Khatian is currently available for this selection.
                    </p>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    */
    ...
    const surveyType =
        document.getElementById('survey_type');
    ...
    const khatianNumberInput =
        document.getElementById('khatian_number');

    const loading =
        document.getElementById('loading');

    const khatianResults =
        document.getElementById('khatian-results');

    const khatianList =
        document.getElementById('khatian-list');

    const noKhatians =
        document.getElementById('no-khatians');
    ...
    const noKhatiansDescription =
        document.getElementById('no-khatians-description');


    /*
    |--------------------------------------------------------------------------
    | Current Loaded Khatians
    |--------------------------------------------------------------------------
    |
    | Mouza থেকে যে Khatians আসবে সেগুলো এখানে রাখা হবে।
    | এরপর Khatian Number search এই data-এর ওপরেই হবে।
    |
    */
    ...
    */
    ...
    function resetResults() {
        ...
        khatianResults.classList.add('hidden');

        noKhatians.classList.add('hidden');

        selectedSurvey.classList.add('hidden');

        khatianList.innerHTML = '';
    ...
    /*
    |--------------------------------------------------------------------------
    | Clear Khatian Search
    |--------------------------------------------------------------------------
    */

    function clearKhatianSearch() {

        khatianNumberInput.value = '';
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Render Khatian Cards
    |--------------------------------------------------------------------------
    */

    function renderKhatians(khatians) {
        ...
        */
        ...
        if (!khatians.length) {
            ...
            khatianResults.classList.add(
                'hidden'
            );

            selectedSurvey.classList.add(
                'hidden'
            );

            noKhatiansDescription.textContent =
                `No ${surveyType.value} survey Khatian found for this search.`;

            noKhatians.classList.remove(
                'hidden'
            );
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | Create Khatian Cards
        |--------------------------------------------------------------------------
        */

        khatians.forEach(function (khatian) {
            ...
            */
            ...
            card.innerHTML = `
                ...
                <span class="map-survey">
                    ${khatianSurvey} Survey
                </span>


                <h4 class="map-card-title">
                    Khatian No. ${khatianNumber}
                </h4>
                ...
                <a
                    href="/khatians/${khatian.id}"
                    class="map-action"
                >

                    View Khatian Details
        ...
        */
        ...
        khatianResults.classList.remove(
            'hidden'
        );
    ...
    division.addEventListener(
        ...
        async function () {
            ...
            try {
                ...
                const response =
                    await fetch(
                        `/khatians/browse/divisions/${divisionId}/districts`
                    );
    ...
    district.addEventListener(
        ...
        async function () {
            ...
            try {
                ...
                const response =
                    await fetch(
                        `/khatians/browse/districts/${districtId}/upazilas`
                    );
    ...
    upazila.addEventListener(
        ...
        async function () {
            ...
            try {
                ...
                const response =
                    await fetch(
                        `/khatians/browse/upazilas/${upazilaId}/mouzas`
                    );
    ...
    */
        ...
        async function () {
            ...
            */
            ...
            try {
                ...
                const response =
                    await fetch(
                        `/khatians/browse/mouzas/${mouzaId}/khatians`
                    );
                ...
                */
                ...
                /*
                |--------------------------------------------------------------------------
                | No Khatian For Selected Survey
                |--------------------------------------------------------------------------
                */

                if (!currentKhatians.length) {

                    noKhatiansDescription.textContent =
                        `No ${selectedType} survey Khatian is currently available for this Mouza.`;
                ...
                */
                ...
                noKhatiansDescription.textContent =
                    'Unable to load khatians. Please try again.';
    ...
    | 455 + Enter
    |
    | তাহলে শুধু Khatian No. 455 দেখাবে।
    |
    */

    khatianNumberInput.addEventListener(
        'keydown',
        function (event) {
            ...
            */
            ...
            |--------------------------------------------------------------------------
            |
            | Empty রেখে Enter দিলে সব Khatian আবার দেখাবে।
            |
            */
            ...
            /*
            |--------------------------------------------------------------------------
            | Search Exact Khatian Number
            |--------------------------------------------------------------------------
            */

            const filteredKhatians =
                currentKhatians.filter(
                    function (khatian) {
            ...
            */
            ...
            if (!filteredKhatians.length) {
                ...
                noKhatiansDescription.textContent =
                    `Khatian No. ${khatianNumberInput.value.trim()} was not found for this Mouza.`;
